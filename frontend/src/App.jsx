...
function App() {
  ...
  const handleFortuneTelling = async () => {
    ...
    try {
      ...
      const response = await analyzeHand(
        processedImageFile,
  ...
  const handleImageAreaClick = () => {
    // true ⇄ false をクリックするたびに交互にひっくり返す
          ...
          <div className="flex flex-col items-center justify-center p-6 bg-[var(--retro-card-bg)] border-2 border-[var(--retro-border)] rounded-none shadow-none max-w-md w-full text-center">
            ...
            {previewImageUrl && (
              <img
                src={previewImageUrl}
                alt="Preview"
                className="max-w-full max-h-80 object-contain rounded-none border-2 border-[var(--retro-border)] mb-6"
              />
            )}
          ...
          <div className="flex flex-col items-center justify-center p-6 bg-[var(--retro-card-bg)] border-2 border-[var(--retro-border)] rounded-none shadow-none max-w-2xl w-full text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6 w-full">
              {characters.map((char) => (
                ...
                >
                  <h3 className="text-xl font-semibold text-[var(--retro-text)] mb-1">
                    {char.name}
                  </h3>
            ...
            {selectedCharacter && (
              <p className="text-lg text-[var(--retro-text)] mb-6">
                選択中:{" "}
                <span className="font-semibold text-[var(--retro-accent)]">
                  {selectedCharacter.name}
                </span>
              </p>
            )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-[var(--retro-card-bg)] border-2 border-[var(--retro-border)] rounded-none shadow-none max-w-4xl w-full">
            {error ? (
              <div className="md:col-span-2 text-center">
                <h2 className="text-3xl font-['Press_Start_2P'] text-[var(--retro-text)] text-red-500 mb-4">
                  ERROR!!
                </h2>
                <p className="text-red-400 text-[var(--retro-text)]">{error}</p>
                <button
                  onClick={resetState}
                  className="bg-[var(--retro-main)] hover:bg-[var(--retro-button-hover)] text-[var(--retro-text)] font-bold py-3 px-6 rounded-none transition-colors duration-100 mt-8 border-2 border-[var(--retro-border)]"
                >
                  もう一度占う
                </button>
              </div>
              ...
              <>
                ...
                <div className="flex flex-col items-center justify-center p-4 bg-[var(--retro-card-bg)] border-2 border-[var(--retro-border)] rounded-none">
                  ...
                  {previewImageUrl && (
                    <img
                      src={previewImageUrl}
                      alt="Your Hand"
                      className="max-w-full max-h-96 object-contain rounded-none border-2 border-[var(--retro-border)]"
                    />
                  )}
                </div>
                ...
                <div className="p-4 bg-[var(--retro-card-bg)] border-2 border-[var(--retro-border)] rounded-none">
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-grow">
                          <div className="flex items-center space-x-2">
                            <span className="font-bold text-[var(--retro-text)] text-lg">
                              {selectedCharacter?.name}
                            </span>
                        ...
                        {handAnalysis?.lifeLine && (
                          <div className="relative">
                            ...
                            <p className="text-[var(--retro-text)]">
                              <strong className="text-[var(--retro-main)]">
                                生命線:
                              </strong>
                  ...
                  <button
                    onClick={resetState}
                    className="bg-[var(--retro-main)] hover:bg-[var(--retro-button-hover)] text-[var(--retro-text)] font-bold py-3 px-6 rounded-none transition-colors duration-100 mt-8 w-full border-2 border-[var(--retro-border)]"
                  >
                    もう一度占う
                  </button>
                </div>
